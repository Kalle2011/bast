# 🎉 bast - Secure Your Terminal Operations with Ease
...
3. Choose the appropriate file for your operating system. For example:
   ...
   - For Linux, download the tarball or binary appropriate for your distribution.
...
### For macOS
- Open the downloaded `.dmg` file and drag the Bast application into your Applications folder.
- Launch Bast from your Applications folder.
...
## 🌐 Usage Instructions
Once you have installed Bast, you can begin using it. Open your terminal and type `bast` to access the command line interface.

Here are some common commands to get you started:
- `bast start`: Starts the Bast system and connects to the Bastio AI Security Gateway.
- `bast status`: Checks the current status of your security settings.
- `bast help`: Displays the help information for available commands.

## 🔒 Features
- **Security Integration:** Seamlessly connects with Bastio AI Security Gateway for enhanced protection.
- **User-Friendly Interface:** Simple commands designed for non-technical users.
...
## 📋 License
Bast is released under the MIT License. Feel free to use it in your projects, modify it, or contribute to its development.

---

By following these steps, you can successfully download and run Bast on your computer. Enjoy a safer terminal experience!